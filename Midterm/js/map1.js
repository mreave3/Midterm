...
//create an object to hold the group of earthquake points
var featuregroup = L.layerGroup();

//creates pop up for earthquake points
function addpopup( feature, layer ){
  var html = feature.properties.mag + " magnitude, " + feature.properties.place;
  layer.bindPopup( html );

 //add the current earthquake point to the group
...
//add the group of earthquake points to the map.
featuregroup.addTo( map );

//adds earthquake data layer to the featuregroup above
var datalayers = {
